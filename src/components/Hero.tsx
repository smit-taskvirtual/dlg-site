 ...
 * Hero
 * ---------------------------------------------------------------------------
 * Full-width image slider. Crossfades between four site images every 6s with
 * arrow controls and dot indicators; auto-advance is disabled for users who
    ...
    <section className="relative" aria-label="Featured images">
      <div className="relative h-[260px] w-full overflow-hidden sm:h-[300px] lg:h-[360px]">
        ...
        <button
          ...
          className="absolute left-4 top-1/2 grid h-10 w-10 -translate-y-1/2 place-items-center rounded-full bg-black/40 text-white transition-colors hover:bg-do"
        >
        ...
        <button
          ...
          className="absolute right-4 top-1/2 grid h-10 w-10 -translate-y-1/2 place-items-center rounded-full bg-black/40 text-white transition-colors hover:bg-do"
        >
          ...
          {slides.map((slide, i) => (
            <button
              ...
              className={`h-2.5 w-2.5 rounded-full transition-colors ${
                i === index ? 'bg-do' : 'bg-white/60 hover:bg-white'
              }`}
            />
          ))}
        </div>
